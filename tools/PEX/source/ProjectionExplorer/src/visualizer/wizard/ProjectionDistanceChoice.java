...
public class ProjectionDistanceChoice extends WizardPanel {
    ...
    public ProjectionDistanceChoice reset() {
        //removing the techniques which are not based on 
        //distance matrices when necessary
        if (pdata.getSourceType() == SourceType.DISTANCE_MATRIX) {
            this.projComboBox.removeAllItems();
            for (ProjectionType pt : ProjectionType.getTypes()) {
        ...
        if (type != null && type.isGenerateDistanceMatrix() &&
