...
public class ProjectionFactory {
    ...
    public static Projection getInstance(ProjectionType type) {
        ...
        if (type.equals(ProjectionType.IDMAP)) {
        ...
        } else if (type.equals(ProjectionType.NJ)) {
            return new NJProjection();
        } else if (type.equals(ProjectionType.SAMMON)) {
