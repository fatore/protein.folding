 ...
 */
public class GraphFameOptions extends javax.swing.JDialog {

    /** Creates new form ProjectionFameOptions */
    private GraphFameOptions(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void minSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_minSliderStateChanged
        if (viewer != null) {
            try {
                ...
                Logger.getLogger(GraphFameOptions.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static GraphFameOptions getInstance(javax.swing.JFrame parent) {
        return new GraphFameOptions(parent);
    }

    public void display(GraphFrame viewer) {
        if (viewer != null) {
