...
//            } else {
//                m_pTempMatH[i].x = (float) (m_pTempMatH[p].x + ((m_pTempMatH[p].m_pDis_F) * ((float) Math.cos(m_pTempMatH[i].t + (m_pTempMatH[i].w / 2)))));
//                m_pTempMatH[i].y = (float) (m_pTempMatH[p].y + ((m_pTempMatH[p].m_pDis_F) * ((float) Math.sin(m_pTempMatH[i].t + (m_pTempMatH[i].w / 2)))));
//            }
//
//        } else {
//            T = m_pTempMatH[i].lv;
...
//    private float T;
    ...
    private ArrayList<NJEdges> Varesta = new ArrayList<NJEdges>();
}
