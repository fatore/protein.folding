    ...
    synchronized void relax() {
        if (this.edges != null && this.instances != null) {
            for (int i = 0; i < edges.size(); i++) {
                ...
                GraphInstance source = (GraphInstance) instances.get(e.getSource());
                GraphInstance target = (GraphInstance) instances.get(e.getTarget());
            ...
            for (int i = 0; i < instances.size(); i++) {
                GraphInstance v1 = (GraphInstance) instances.get(i);
                float dx = 0;
                float dy = 0;
                ...
                for (int j = 0; j < instances.size(); j++) {
                    ...
                    GraphInstance v2 = (GraphInstance) instances.get(j);
            ...
            for (int i = 0; i < instances.size(); i++) {
                GraphInstance v = (GraphInstance) instances.get(i);
...
//                }
    ...
    public void start(Connectivity connectivity) {
        if (connectivity != null) {
            ...
            for (Edge e : this.edges) {
                ...
                if (e.getWeight() < this.min_length) {
    ...
    public void stop() {
        ...
        model.normalizeVertex(model.getInstanceSize() * 5 + 10, ((float) (d.getHeight())) / 1.65f);
