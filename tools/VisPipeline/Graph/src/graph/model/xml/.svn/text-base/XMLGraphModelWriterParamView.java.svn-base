 ...
 */
public class XMLGraphModelWriterParamView extends AbstractParametersView {

    /** Creates new form XMLModelWriterParamView */
    public XMLGraphModelWriterParamView(XMLGraphModelWriterComp comp) {
        initComponents();
    ...
    private void matrixButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matrixButtonActionPerformed
        try {
            ...
            Logger.getLogger(XMLGraphModelWriterParamView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private XMLGraphModelWriterComp comp;
