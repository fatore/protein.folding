 ...
 */
public class XMLGraphModelReaderParamView extends AbstractParametersView {

    /** Creates new form XMLModelReaderParamView */
    public XMLGraphModelReaderParamView(XMLGraphModelReaderComp comp) {
        initComponents();
    ...
    private void matrixButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matrixButtonActionPerformed
        try {
            ...
            Logger.getLogger(XMLGraphModelReaderParamView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private XMLGraphModelReaderComp comp;
