...
public class CovarianceTopicSettings extends javax.swing.JDialog {
    ...
    private CovarianceTopicSettings(javax.swing.JFrame parent) {
        super(parent);
        initComponents();
    }
...
private void cancekButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancekButtonActionPerformed
    ...
    public static CovarianceTopicSettings getInstance(javax.swing.JDialog parent) {
        return new CovarianceTopicSettings(parent);
    }

    public static CovarianceTopicSettings getInstance(javax.swing.JFrame parent) {
        return new CovarianceTopicSettings(parent);
    }

    public void display(CovarianceTopic covtopic) {
        if (covtopic != null) {
            this.covtopic = covtopic;
            percentageTermsTextField.setText(Float.toString(covtopic.getPercentageTerms()));
            percentageTopicsTextField.setText(Float.toString(covtopic.getPercentageTopics()));
    ...
    private void refreshData() {
        if (covtopic != null) {
            covtopic.setPercentageTerms(Float.parseFloat(percentageTermsTextField.getText()));
            covtopic.setPercentageTopics(Float.parseFloat(percentageTopicsTextField.getText()));
        }
    }

    private CovarianceTopic covtopic;
