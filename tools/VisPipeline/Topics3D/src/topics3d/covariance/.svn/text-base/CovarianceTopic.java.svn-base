...
/**
 *
 * @author Jorge Poco, Fernando Vieira Paulovich
 */
public class CovarianceTopic extends AbstractTopic3DCreator {

    public CovarianceTopic(TopicProjection3DModel model) {
        super(model);
        this.percterms = 0.5f;
    ...
    @Override
    public Topic3D createTopic(ArrayList<TopicProjection3DInstance> instances) throws IOException {
        ...
        AbstractMatrix matrix = pp.getMatrixSelected(lowercut, uppercut, ngrams,
                StemmerType.ENGLISH, new ArrayList<AbstractInstance>(instances));
        ...
        return new Topic3D(model, instances, boxes);
    }
    ...
    private void createTopic(float[][] points, ArrayList<String> attributes,
            ArrayList<TopicProjection3DInstance> instances,
    ...
    private void colorVertex(float[][] points, ArrayList<TopicProjection3DInstance> instances,
