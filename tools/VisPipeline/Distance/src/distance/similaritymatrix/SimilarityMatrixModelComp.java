 ...
 */
@VisComponent(hierarchy = "Distance.Basics",
name = "Similarity Matrix Model",
description = "Define a model of a similarity matrix.")
public class SimilarityMatrixModelComp implements AbstractComponent {
    ...
    public void execute() throws IOException {
        ...
        if (matrix != null) { //using a matrix
            ...
            model = smc.execute(matrix, diss);
        } else if (dmat != null) { //using a distance matrix
            model = smc.execute(dmat);
        } else {
    ...
    public AbstractParametersView getParametersEditor() {
        if (paramview == null) {
            paramview = new SimilarityMatrixCreationParamView(this);
        }
