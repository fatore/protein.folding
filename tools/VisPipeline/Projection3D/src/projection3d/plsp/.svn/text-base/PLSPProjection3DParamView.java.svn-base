 ...
 */
public class PLSPProjection3DParamView extends AbstractParametersView {

    /** Creates new form PLSPProjection2DParamView */
    public PLSPProjection3DParamView(PLSPProjection3DComp comp) {
        initComponents();
    ...
    private PLSPProjection3DComp comp;
