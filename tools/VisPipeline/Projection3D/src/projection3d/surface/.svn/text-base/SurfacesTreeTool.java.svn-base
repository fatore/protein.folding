...
import projection3d.view.tools.ClusteringView;
 ...
 * @author jpocom
 */
public class SurfacesTreeTool extends ModelViewer {

    /** Creates new form SurfacesTreeTool */
    public SurfacesTreeTool() {
        initComponents();
    ...
    private void clusterOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clusterOptionActionPerformed
        if (model != null) {
            ClusteringView.getInstance(SurfacesTreeTool.this).display((Projection3DModel) model, clustersTree);
        }
    ...
    class CustomTreeCellRenderer extends DefaultTreeCellRenderer {
        ...
        public Component getTreeCellRendererComponent(JTree tree, Object value,
            ...
            if (node.isRoot()) {
                ...
                setIcon(new ColorIcon(actor.getColor()));
