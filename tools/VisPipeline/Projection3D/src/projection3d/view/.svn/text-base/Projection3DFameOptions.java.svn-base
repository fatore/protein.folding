 ...
 * @author jpocom
 */
public class Projection3DFameOptions extends javax.swing.JDialog {

    /** Creates new form ProjectionFameOptions */
    private Projection3DFameOptions(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void minSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_minSliderStateChanged
        if (viewer != null) {
            try {
                ...
                Logger.getLogger(Projection3DFameOptions.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static Projection3DFameOptions getInstance(javax.swing.JFrame parent) {
        return new Projection3DFameOptions(parent);
    }

    public void display(Projection3DFrame viewer) {
        if (viewer != null) {
    ...
    private Projection3DFrame viewer;
