 ...
 */
public class TopicProjectionInstance extends ProjectionInstance {

    public TopicProjectionInstance(TopicProjectionModel model, int id) {
        super(model, id);
    }

    public TopicProjectionInstance(TopicProjectionModel model, int id, float x, float y) {
        super(model, id, x, y);
    ...
    public void draw(BufferedImage image, boolean highquality) {
        ...
        TopicProjectionModel tmodel = (TopicProjectionModel) model;
        ...
        if (drawAsCircles) {
            ...
            if (selected) {
                ...
                float alpha = ((TopicProjectionModel) model).getAlpha();
    ...
    public int getSize() {
        int inssize = ((TopicProjectionModel) model).getInstanceSize();
