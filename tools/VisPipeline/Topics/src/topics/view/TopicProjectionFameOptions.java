...
/*
 * TopicProjectionFameOptions.java
 *
 ...
 */
public class TopicProjectionFameOptions extends javax.swing.JDialog {

    /** Creates new form TopicProjectionFameOptions */
    private TopicProjectionFameOptions(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void minSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_minSliderStateChanged
        if (viewer != null) {
            try {
                ...
                Logger.getLogger(TopicProjectionFameOptions.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static TopicProjectionFameOptions getInstance(javax.swing.JFrame parent) {
        return new TopicProjectionFameOptions(parent);
    }

    public void display(TopicProjectionFrame viewer) {
        if (viewer != null) {
    ...
    private TopicProjectionFrame viewer;
