...
/*
 * BinaryMatrixWriterParamView.java
 *
 ...
 */
public class BinaryMatrixWriterParamView extends AbstractParametersView {

    /** Creates new form BinaryMatrixWriterParamView */
    public BinaryMatrixWriterParamView(BinaryMatrixWriterComp comp) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Binary Matrix Writer"));
    ...
    private void matrixButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matrixButtonActionPerformed
        try {
            ...
            int result = SaveDialog.showSaveDialog(spm, new BINFilter(), this, "matrix.data");
    ...
    private BinaryMatrixWriterComp comp;
