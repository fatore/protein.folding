...
class fsmvis 
{
	...
	//create a temporary data collection and layout model 
	DataItemCollection data = new DataItemCollection();
	Viewer viewer;
	LayoutModel tmp = new NeighbourAndSampleModel(data, new EndCriteria(0, 0, 0.0, 0, 0), null);
	
	for (int i=0; i<args.length; i++){
	    System.out.println(i+" "+args[i]);
	}

	    viewer = new Viewer(tmp);
