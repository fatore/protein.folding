...
import plsp.selection.GroupSelection;
 ...
 */
public class ProjectionFrame extends ModelViewer {
    ...
    public ProjectionFrame() {
        ...
        //addSelection(new GroupSelection(this));
        //addSelection(new NewPLSPReprojectSelection(this));
        //addSelection(new PLSPReprojectSelection(this));
        //addSelection(new NewPLSPReprojectSelection(this));
        addSelection(new DynamicColorSelection(this));
        //addSelection(new ColorIdentityCoordinationSelection(this));
    }
    ...
    private void initComponents() {
        ...
        groupSelectedjMenuItem = new javax.swing.JMenuItem();
        groupPLSPPatchesjMenuItem = new javax.swing.JMenuItem();
        groupPatchesFromSelectionjMenuItem = new javax.swing.JMenuItem();
        ...
        groupSelectedjMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_G, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        groupSelectedjMenuItem.setText("Group Selected Instances");
        groupSelectedjMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                groupSelectedjMenuItemActionPerformed(evt);
            }
        });
        GroupsMenu.add(groupSelectedjMenuItem);

        groupPLSPPatchesjMenuItem.setText("Group P-LSP Patches");
        groupPLSPPatchesjMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                groupPLSPPatchesjMenuItemActionPerformed(evt);
            }
        });
        GroupsMenu.add(groupPLSPPatchesjMenuItem);

        groupPatchesFromSelectionjMenuItem.setText("Group P-LSP Patches from Selection");
        groupPatchesFromSelectionjMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                groupPatchesFromSelectionjMenuItemActionPerformed(evt);
            }
        });
        GroupsMenu.add(groupPatchesFromSelectionjMenuItem);

        menuTool.add(GroupsMenu);
...
//
//                    try {
//                        AbstractMatrix matrix = Util.modelToMatrix((ProjectionModel) model, getCurrentScalar());
...
//                                try {
//                                    String filename = OpenDialog.getFilename();
//                                    Util.importScalars((ProjectionModel) model, filename);
//                                    updateScalars(null);
//                                } catch (IOException ex) {
//                                    Logger.getLogger(ProjectionFrame.class.getName()).log(Level.SEVERE, null, ex);
//                                } finally {
...
//                    if (model != null) {
//                        String filename = SaveDialog.getFilename();
//                        Util.exportScalars((ProjectionModel) model, filename);
//                    }
//                }
//            } catch (IOException ex) {
//                Logger.getLogger(ProjectionFrame.class.getName()).log(Level.SEVERE, null, ex);
...
//        ProjectionFameOptions.getInstance(this).display(this);
    ...
    private void groupSelectedjMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_groupSelectedjMenuItemActionPerformed
//        // TODO add your handling code here:
//        ArrayList<AbstractInstance> selinst = this.model.getSelectedInstances();
//        SelectionFactory.getInstance(SelectionFactory.SelectionType.GROUP, this).selected(selinst);
    }//GEN-LAST:event_groupSelectedjMenuItemActionPerformed

    private void groupPLSPPatchesjMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_groupPLSPPatchesjMenuItemActionPerformed
//        // TODO add your handling code here:
//        if (model instanceof PLSPProjectionModel) {
//            System.out.println("\n\nGrouping");
//            for (int i = 0; i < ((PLSPProjectionModel) model).getPatches().size(); i++) {
//                ArrayList<AbstractInstance> selinst = ((PLSPProjectionModel) model).getPatches().get(i);
//                System.out.println(selinst.size() + " = Size of Cluster " + i);
//                //SelectionFactory.getInstance(SelectionFactory.SelectionType.GROUP, this).selected(selinst);
//                ((GroupSelection) SelectionFactory.getInstance(SelectionFactory.SelectionType.GROUP, this)).groupInstances(selinst);
//            }
//            System.out.println("# instances: " + model.getInstances().size());
//        } else {
//            JOptionPane.showMessageDialog(null,
//                    "You need to use the Persistent PLSP Model to Perform this Operation.");
//        }
    }//GEN-LAST:event_groupPLSPPatchesjMenuItemActionPerformed

    private void groupPatchesFromSelectionjMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_groupPatchesFromSelectionjMenuItemActionPerformed
//        // TODO add your handling code here:
//        if (model instanceof PLSPProjectionModel) {
//            ArrayList<ProjectionInstance> selinst = this.model.getSelectedInstances();
//            HashSet<Integer> patchSet = new HashSet<Integer>();
//            for (ProjectionInstance pi : selinst) {
//                Integer patchID = (Integer) ((PLSPProjectionModel) model).getPatchMap().get(pi.getId());
...
//                SelectionFactory.getInstance(SelectionFactory.SelectionType.GROUP, this).selected(((PLSPProjectionModel) model).getPatches().get(patchID));
//            }
//        } else {
//            JOptionPane.showMessageDialog(null,
//                    "You need to use the Persistent PLSP Model to Perform this Operation.");
//        }
    }//GEN-LAST:event_groupPatchesFromSelectionjMenuItemActionPerformed
...
//            float iniX = ((ProjectionModel) model).getInstances().get(0).getX();
//            float iniY = ((ProjectionModel) model).getInstances().get(0).getY();
//            float max_x = iniX, max_y = iniX;
//            float min_x = iniY, min_y = iniY;
//            int zero = 30;
//
//            for (int i = 1; i < model.getInstances().size(); i++) {
//                float x = ((ProjectionModel) model).getInstances().get(i).getX();
//                if (max_x < x) {
//                    max_x = x;
//                } else if (min_x > x) {
//                    min_x = x;
//                }
//
//                float y = ((ProjectionModel) model).getInstances().get(i).getY();
//                if (max_y < y) {
//                    max_y = y;
//                } else if (min_y > y) {
//                    min_y = y;
...
//            }
//
//            for (AbstractInstance pi : ((ProjectionModel) model).getInstances()) {
...
//            model.notifyObservers();
        ...
        public ArrayList<ProjectionInstance> getSelectedInstances(Polygon polygon) {
            ...
            if (model != null) {
                ...
                //expanding grouped projection instances
                if (!(selection instanceof GroupSelection)) {
                    for (int i = 0; i < selected.size(); i++) {
                        if (selected.get(i) instanceof GroupedProjectionInstance) {
                            GroupedProjectionInstance gi = (GroupedProjectionInstance) selected.get(i);
                            for (int j = 0; j < gi.getGroupedInstances().size(); j++) {
                                selected.add(gi.getGroupedInstances().get(j));
                            }
                        }
                    }
                }
            ...
            if (model != null) {
                ...
                if (!(selection instanceof GroupSelection)) {
                    for (int i = 0; i < selinstances.size(); i++) {
                        if (selinstances.get(i) instanceof GroupedProjectionInstance) {
                            GroupedProjectionInstance gi = (GroupedProjectionInstance) selinstances.get(i);
                            for (int j = 0; j < gi.getGroupedInstances().size(); j++) {
                                selinstances.add(gi.getGroupedInstances().get(j));
                            }
                        }
                    }
                }
...
//            if (model != null) {
//                ArrayList<ProjectionInstance> insts = new ArrayList<ProjectionInstance>();
//                Scalar scalar = ((ProjectionModel) model).addScalar("cdata");
//                for (ProjectionInstance inst : ((ProjectionModel) model).getInstances()) {
//                    if (inst.getScalarValue(scalar) == val) {
//                        insts.add(inst);
//                    }
//                }
//
...
//
//                        for (AbstractInstance pi : ((ProjectionModel) model).getSelectedInstances()) {
//                            pi.setX(x + pi.getX());
//                            pi.setY(y + pi.getY());
//                        }
//
                    ...
                    if (model != null) {
                        ...
                        if (instance != null) {
                            ...
                            if (evt.getClickCount() == 2) {
                                if (selection instanceof GroupSelection) {
                                    if (instance instanceof GroupedProjectionInstance) {
                                        ((GroupedProjectionInstance) instance).splitGroup();
...
//                seltarget = null;
    ...
    public static void main(String[] args) {
        try {
            ...
            proj.setDissimilarityType(DissimilarityType.EUCLIDEAN);
    ...
    private javax.swing.JMenuItem groupPLSPPatchesjMenuItem;
    private javax.swing.JMenuItem groupPatchesFromSelectionjMenuItem;
    private javax.swing.JMenuItem groupSelectedjMenuItem;
