...
/*
 * PersistentPLSPBinaryWriterParamView.java
 *
 * Created on 01/08/2009, 17:59:01
 */
 ...
 */
public class PersistentPLSPBinaryWriterParamView extends AbstractParametersView {

    /** Creates new form PersistentPLSPBinaryWriterParamView */
    public PersistentPLSPBinaryWriterParamView(PersistentPLSPBinaryWriterComp comp) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Persistent P-LSP Binary FIle Writer"));
        ...
        getAccessibleContext().setAccessibleName("Binary Persistent P-LSP Writer");
    ...
    private void matrixButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matrixButtonActionPerformed
        try {
            ...
            int result = SaveDialog.showSaveDialog(spm, new PLSPBinFilter(), this, "PLSP.plspbin");
            if (result == JFileChooser.APPROVE_OPTION) {
                String filename = SaveDialog.getFilename();
                matrixTextField.setText(filename);
            }
        } catch (IOException ex) {
            Logger.getLogger(PersistentPLSPBinaryWriterParamView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private PersistentPLSPBinaryWriterComp comp;
