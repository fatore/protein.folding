...
public class JoinScalars extends javax.swing.JDialog {
    ...
    private void joinButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_joinButtonActionPerformed
        if (model != null) {
            scalar = model.addScalar(ProjectionConstants.JOIN);
            ...
            for (AbstractInstance ai : model.getInstances()) {
                ...
                for (int i = 0; i < tojoin.size(); i++) {
                    max = Math.max(max, pi.getScalarValue(tojoin.get(i)));
                }

                pi.setScalarValue(scalar, max);
            }
    ...
    public static JoinScalars getInstance(java.awt.Frame parent) {
    ...
    private void setScalars(ProjectionModel model) {
        ...
        for (int i = 0; i < scalars.size(); i++) {
            if (!scalars.get(i).getName().equals(ProjectionConstants.DOTS) &&
                    !scalars.get(i).getName().equals(ProjectionConstants.JOIN)) {
