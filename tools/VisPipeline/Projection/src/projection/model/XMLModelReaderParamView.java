 ...
 */
public class XMLModelReaderParamView extends AbstractParametersView {

    /** Creates new form XMLModelReaderParamView */
    public XMLModelReaderParamView(XMLModelReaderComp comp) {
        initComponents();
    ...
    private void matrixButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matrixButtonActionPerformed
        try {
            ...
            Logger.getLogger(XMLModelReaderParamView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private XMLModelReaderComp comp;
