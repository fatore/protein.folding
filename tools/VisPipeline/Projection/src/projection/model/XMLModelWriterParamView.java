 ...
 */
public class XMLModelWriterParamView extends AbstractParametersView {

    /** Creates new form XMLModelWriterParamView */
    public XMLModelWriterParamView(XMLModelWriterComp comp) {
        initComponents();
    ...
    private void matrixButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_matrixButtonActionPerformed
        try {
            ...
            Logger.getLogger(XMLModelWriterParamView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private XMLModelWriterComp comp;
