...
public abstract class Corpus {
     ...
     * @throws IOException 
     */
    public abstract String getFullContent(int id) throws IOException;
     ...
     * @throws IOException 
     */
    public abstract String getFilteredContent(int id) throws IOException;
     ...
     * @throws IOException 
     */
    public abstract String getViewContent(int id) throws IOException;
     ...
     * @throws IOException 
     */
    public abstract String getSearchContent(int id) throws IOException;
     ...
     */
    public abstract ArrayList<Ngram> getNgrams(int id) throws IOException;
    ...
    /**
     * Get the label of a document belonging to this corpus.
     * @param nrLines The number of lines used to construct the label.
     * @param id The document id
     * @return The label of a documents.
