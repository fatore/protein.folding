 ...
 */
public class StreammingProjectionFameOptions extends javax.swing.JDialog {

    /** Creates new form ProjectionFameOptions */
    private StreammingProjectionFameOptions(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void minSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_minSliderStateChanged
        if (viewer != null) {
            try {
                ...
                Logger.getLogger(StreammingProjectionFameOptions.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static StreammingProjectionFameOptions getInstance(javax.swing.JFrame parent) {
        return new StreammingProjectionFameOptions(parent);
    }

    public void display(StreammingProjectionFrame viewer) {
        if (viewer != null) {
    ...
    private StreammingProjectionFrame viewer;
